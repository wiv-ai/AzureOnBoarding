...
-- ========================================================
-- Auto-generated on: Thu Aug 14 06:29:26 PM UTC 2025
...
-- Storage Account: billingstorage95541
...
CREATE MASTER KEY ENCRYPTION BY PASSWORD = 'StrongP@ssw0rd5ca9f2df!';
GO
...
SELECT *
FROM OPENROWSET(
    BULK 'abfss://billing-exports@billingstorage95541.dfs.core.windows.net/billing-data/DailyBillingExport/*/*.csv',
    FORMAT = 'CSV',
    PARSER_VERSION = '2.0',
    FIRSTROW = 2
)
